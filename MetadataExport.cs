...
sb.Append("ObjectName" + '\t' + "TableName" + '\t' + "ObjectType" + '\t' + "SourceColumn" + '\t' + "DataType" + '\t' + "Expression" + '\t' +
          "HiddenFlag" + '\t' + "Format" + '\t' + "PrimaryKey" + '\t' + "SummarizeBy" +'\t' + "DisplayFolder" + '\t' + "DataCategory" + '\t' + "SortByColumn" + '\t' + "Description" + newline);
...
foreach (var t in Model.Tables.ToList())
{
    foreach (var o in t.Measures.ToList())
    {
        ...
        fs + '\t' + "" + '\t' + "" + '\t' + o.DisplayFolder + '\t' + "" + '\t' + "" + '\t' + o.Description + newline);
    }
}
